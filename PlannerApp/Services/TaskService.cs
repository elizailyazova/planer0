...
namespace WPlannerApp.Services
{
    public class TaskService
    {
        ...
        public void AddTask(TaskItem task, RecurrenceModel recurrence = null)
        {
            ...
            using (var connection = new MySqlConnection(connectionString))
            {
                ...
                string query =
                    "INSERT INTO task (title, description, date, time, category, repeat_type) VALUES (@title, @description, @date, @time, @category, @repeat_type); SELECT LAST_INSERT_ID();";
        ...
        private void GenerateRecurringTasks(TaskItem task, RecurrenceModel recurrence, MySqlConnection connection)
        {
        ...
        private void AddRecurringTask(TaskItem task, DateTime date, MySqlConnection connection, int recurrenceId)
        {
            string query = "INSERT INTO task (title, description, date, time, category, repeat_type, RecurrenceId) VALUES (@title, @desc, @date, @time, @category, @repeat, @recurrenceId)";
